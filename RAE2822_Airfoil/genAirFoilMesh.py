...
# PS parameters
dX1PS = 0.0025  # first dx from the LE
Alpha1PS = 1.2  # clustering from the LE
dX2PS = 5e-4  # first dx from the TE
Alpha2PS = 1.2  # clustering from the TE
dXMaxPS = 0.015  # max dx for PS
# SS parameters
dX1SS = 0.0025  # first dx from the LE
Alpha1SS = 1.2  # clustering from the LE
dX2SS = 5e-4  # first dx from the TE
Alpha2SS = 1.2  # clustering from the TE
dXMaxSS = 0.015  # max dx for SS
# TE parameters
