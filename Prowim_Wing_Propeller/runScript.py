...
class Top(Multipoint):
    ...
    def configure(self):
        ...
        self.geometry.nom_addLERadiusConstraints("radius", leList, nSpan=10, axis=[0, 1, 0], chordDir=[-1, 0, 0])
        # wing surface spanwise curvature constraint
        ...
        self.dvs.add_output("actuator_disk", val=np.array([0.3]))
        # manually connect the dvs output to the geometry and scenario1
        self.connect("twist", "geometry.twist")
        self.connect("shape", "geometry.shape")
        self.connect("patchV", "scenario1.patchV")
        self.connect("actuator_disk", "scenario1.actuator_disk")
        ...
        self.add_design_var("actuator_disk", lower=0.2, upper=0.6, scaler=1.0)
        ...
        self.add_constraint("geometry.radius", lower=1.0, upper=3.0, scaler=1.0)
