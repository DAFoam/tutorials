...
class Top(Multipoint):
    def setup(self):
        ...
        for discipline in ["aero"]:
            self.connect("geometry.x_%s0_geometry_output" % discipline, "hover0.x_%s0_masked" % discipline)
            self.connect("geometry.x_%s0_geometry_output" % discipline, "hover1.x_%s0_masked" % discipline)
            self.connect("geometry.x_%s0_geometry_output" % discipline, "hover2.x_%s0_masked" % discipline)
        for discipline in ["struct"]:
            self.connect("geometry.x_%s0_geometry_output" % discipline, "hover0.x_%s0" % discipline)
            self.connect("geometry.x_%s0_geometry_output" % discipline, "hover1.x_%s0" % discipline)
            self.connect("geometry.x_%s0_geometry_output" % discipline, "hover2.x_%s0" % discipline)
